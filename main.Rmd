...
quantile(std$diffmin, na.rm = TRUE)
...
map_data$klasse <- cut(map_data$diffmin, c(-220,0,18,70,330),  labels = c("kürzer", "etwas länger", "länger","viel länger"))
...
p7 <- ggplot() +
    ...
    #scale_fill_manual(values=c("viel länger" = "#441F21",
#"länger" = "#775C5D",
#"etwas länger" = "#AA999A",
#"kürzer" = "#ffa630"))+
